<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\www\wxshop\public/../application/admin\view\user\index.html";i:1491358660;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
  ...
  <section class="content content-boxed overflow-hidden">
    <div class="content-grid">
      <div class="form-inline">
        <div class="input-group push-5"> <a class="btn btn-sm btn-default" href="<?php echo url($tablename.'/add'); ?>">添加<?php echo $title; ?></a></div>
        <div class="input-group push-5">
          <input type="text" class="form-control input-sm" placeholder="搜索用户名或电话" value="<?php echo isset($params['key'])?$params['key']:''; ?>">
      ...
      <div class="row">
        <table class="js-table-checkable table table-hover">
          ...
          <tr>
            ...
            <td><p class="font-w600 push-5"><?php echo $vo['username']; ?></p>
              <p class="text-muted remove-margin-b">联系人:<?php echo $vo['rename']; ?> 电话:<?php echo $vo['tel']; ?></p></td>
             <td>
			 <?php if($vo['role_id'] != '0'): ?><i data-href="<?php echo url($tablename.'/check',['id'=>$vo['id']]); ?>" class="si <?php echo !empty($vo['state']) && $vo['state']==1?'si-check text-success':'si-close text-danger'; ?>"></i>
			 <?php else: ?>
			  ---
			  <?php endif; ?>
			 </td>			
