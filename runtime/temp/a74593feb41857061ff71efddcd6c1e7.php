<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\wxshop\public/../application/admin\view\login\index.html";i:1491875834;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
...
<head>
<meta charset="utf-8">
<title>登录-<?php echo Config('systemname'); ?></title>
      ...
      <section class="content content-boxed">
        ...
        <div class="row items-push push-50-t push-30">
          <div class="col-md-6 col-md-offset-3">
			<form class="form-horizontal js-validation-login" action="<?php echo url('Login/index'); ?>" id="frmUserInfo" novalidate method="post">
              <div class="form-group">
                <div class="col-xs-12">
                  <div class="form-material form-material-primary">
                    <input class="form-control" type="text" id="username" name="username" placeholder="输入你的用户名.." />
              ...
              <div class="form-group">
                <div class="col-xs-12">
                  <div class="form-material form-material-primary">
                    <input class="form-control" type="password" id="password" name="password" placeholder="输入登录密码" />
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <div class="form-material form-material-primary">
                            <input class="form-control" type="text" name="verify" id="verify"  placeholder="输入验证码" data-error="验证码错误" style="width:70%;float:left" />
                            <img src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>?x='+Math.random();" style="float：right;" alt="验证码" />
              ...
              <div class="form-group">
                <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                  <button class="btn btn-block btn-primary" type="submit"><i class="fa fa-arrow-right pull-right"></i>登录</button>
                </div>
              </div>
    ...
    <!-- <div class="bg-gray-lighter">
      <section class="content content-full content-boxed">
        <div class="push-20-t push-20 text-center">
          <h3 class="h4 push-20 visibility-hidden" data-toggle="appear">没有账户?</h3>
          <a class="btn btn-rounded btn-noborder btn-lg btn-success visibility-hidden" data-toggle="appear" data-class="animated bounceIn" href="frontend_signup.html">马上注册</a> </div>
      </section>
    </div>-->
...
<script src="<?php echo Config('public'); ?>assets/js/pages/pages_form_login.js"></script>
<script>
$(function () {
