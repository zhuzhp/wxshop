<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\www\wxshop\public/../application/admin\view\article_category\index.html";i:1491978671;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
...
<div class="bg-white">
  <section class="content content-boxed overflow-hidden">
    <div class="content-grid">
      <form id="sortForm" action="<?php echo url('article_category/modifylistupdatesort'); ?>" method="post">
        ...
        <div class="form-inline">
          ...
          <span class="input-group-btn">
            <button class="btn btn-sm btn-default" type="button" onclick="var v=$(this).parent().prev().val(); location.href='<?php echo url('article_category/index', u_pam($params, null, array('page','key'))); ?>?key='+v;"> <i class="fa fa-search"></i> </button>
          </span>
          </div>
          <select class="form-control input-sm" onchange="location.href='<?php echo url('article_category/index', u_pam($params, null, array('page','pagesize'))); ?>?pagesize='+this.value">
          ...
          <table class="js-table-checkable table table-hover">
            ...
            <tr class="list-box">
              ...
              <td>
                ...
                <a data-href="<?php echo url('article_category/delete',['id'=>$vo['id'],'controller'=>'article_category']); ?>" onclick="deleleCate(this)" class="btn btn-xs btn-default delete-one" type="button" data-toggle="tooltip" title="" data-original-title="删除"><i class="fa fa-times"></i></a>
              </td>
            </tr>
      ...
      <div class="block block-themed block-transparent remove-margin-b">
        ...
        <div class="block-content">
          <div class="block-content block-content-narrow">
            <form class="js-validation form-horizontal push-10-t" action="<?php echo url('article_category/addsoncate'); ?>" method="post" novalidate="novalidate">
  ...
  <div class="modal-dialog modal-dialog-top">
    <div class="modal-content">
      <div class="block block-themed block-transparent remove-margin-b">
        ...
        <div class="block-content">
          <div class="block-content block-content-narrow">
            <form class="js-validation-role form-horizontal push-10-t" action="<?php echo url('article_category/modify'); ?>" method="post" novalidate="novalidate">
              <div class="form-group">
                <div class="col-sm-9">
                  <div class="form-material">
                    <input type="hidden" name="controller" value="article_category">
