<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\www\wxshop\public/../application/admin\view\article\index.html";i:1491724981;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
    ...
    <form id="articleForm" action="<?php echo url($tablename.'/index'); ?>" method="get">
      <div class="form-inline">
        <div class="input-group push-5">
          ...
          <a class="btn btn-sm btn-default" href="<?php echo url('ArticleCategory/index'); ?>"><?php echo $title; ?>分类</a>
        </div>
        <div class="input-group push-5">
          <input type="text" class="form-control input-sm" placeholder="搜索文章名称" name="key" value="<?php echo isset($params['key'])?$params['key']:''; ?>">
        ...
        <select class="form-control input-sm" name="cateid" onchange="$('#articleForm').submit();">
          <?php if(empty($params['cateid']) || (($params['cateid'] instanceof \think\Collection || $params['cateid'] instanceof \think\Paginator ) && $params['cateid']->isEmpty())): ?><option value="">--请选择文章分类--</option><?php else: ?><option value="<?php echo $params['cateid']; ?>"><?php echo getArticleCateName($params['cateid']); ?></option><?php endif; if(is_array($categorylist) || $categorylist instanceof \think\Collection || $categorylist instanceof \think\Paginator): $i = 0; $__LIST__ = $categorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($cate['id'] != $params['cateid']): ?>
          ...
          <?php endif; endforeach; endif; else: echo "" ;endif; if(!(empty($params['cateid']) || (($params['cateid'] instanceof \think\Collection || $params['cateid'] instanceof \think\Paginator ) && $params['cateid']->isEmpty()))): ?><option value="">--请选择文章分类--</option><?php endif; ?>
        </select>
