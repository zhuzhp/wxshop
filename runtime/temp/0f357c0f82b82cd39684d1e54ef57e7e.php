<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\www\wxshop\public/../application/admin\view\pagesetting\modifyvalue.html";i:1491978356;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
  ...
  <section class="content content-boxed">
    ...
    <div class="row items-push push-50-t push-30">
      <div class="col-md-6 col-md-offset-3">
        <form class="js-validation-pagesettingvalue form-horizontal push-10-t" action="<?php echo url($tablename.'/'.$modify,['id'=>$settinginfo['id']]); ?>" method="post">
            <input type="hidden" name="editid" value="<?php echo isset($info['id'])?$info['id']:''; ?>">
            <?php if(fields($settinginfo['fields'],'title')): ?>
		  ...
		  <?php endif; if(fields($settinginfo['fields'],'entitle')): ?>
          <div class="form-group">
            <div class="col-sm-9">
              <div class="form-material">                
                <input class="form-control" type="text" id="entitle" name="entitle" value="<?php echo isset($info['entitle'])?$info['entitle']:''; ?>" placeholder="输入副标题.">
                <label for="entitle">副标题</label>
              </div>
            </div>
          </div>
		  <?php endif; if(fields($settinginfo['fields'],'url')): ?>
          <div class="form-group">
            <div class="col-sm-9">
              <div class="form-material">
                <input class="form-control" type="text" id="url" name="url" value="<?php echo isset($info['url'])?$info['url']:''; ?>" placeholder="输入链接.">
                <label for="url">链接</label>
              </div>
            </div>
          </div>
		  <?php endif; if(fields($settinginfo['fields'],'info')): ?>
          <div class="form-group">
            <div class="col-sm-12">
              <div class="form-material">
		  ...
		  <?php endif; if(fields($settinginfo['fields'],'content')): ?>
          <div class="form-group">
            <div class="col-sm-12">
              <div class="form-material">
		  ...
		  <?php endif; if(fields($settinginfo['fields'],'image')): ?>   
          <div class="form-group">
            <div class="col-xs-12">
...
<script src="<?php echo Config('public'); ?>assets/js/pages/pages_form_pagesettingvalue.js"></script>
<script>
$(function () {
