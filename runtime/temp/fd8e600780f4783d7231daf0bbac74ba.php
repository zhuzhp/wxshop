<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\www\wxshop\public/../application/admin\view\pagesetting\modify.html";i:1491978322;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
...
<title>
<?php echo $title; ?>列表
<?php $groupnav = 'System'; $activenav = 'Pagesetting/index'; ?>
  ...
  <section class="content content-boxed">
    ...
    <div class="row items-push push-50-t push-30">
      <div class="col-md-6 col-md-offset-3">
        <form class="js-validation-pagesetting form-horizontal push-10-t" action="<?php echo url($tablename.'/'.$modify); ?>" method="post">
          <div class="form-group">
            <div class="col-xs-12">
              <div class="form-material form-material-primary">
			  <input type="hidden" name="id" value="<?php echo isset($info['id'])?$info['id']:''; ?>">
                <input class="form-control" type="text" id="title" name="title" value="<?php echo isset($info['title'])?$info['title']:''; ?>" placeholder="输入文章标题.">
		  ...
		  <div class="col-xs-12">
              <div class="form-material form-material-primary">
                <input class="form-control" type="text" id="key" name="key" value="<?php echo isset($info['key'])?$info['key']:''; ?>" <?php echo isset($info['key'])?'readonly':''; ?> placeholder="输入文章标题.">
          ...
          <div class="form-group">
            ...
            <div>
                <label class="radio-inline css-input css-checkbox css-checkbox-primary"><input type="checkbox" id="val-terms1" <?php if(!(empty($info['fields']) || (($info['fields'] instanceof \think\Collection || $info['fields'] instanceof \think\Paginator ) && $info['fields']->isEmpty()))): ?><?php echo fields($info['fields'],'content')?'checked':''; endif; ?> value="content" name="fields[]"><span></span> 内容</label> 
				<label class="radio-inline css-input css-checkbox css-checkbox-primary"><input type="checkbox" id="val-terms2" <?php if(!(empty($info['fields']) || (($info['fields'] instanceof \think\Collection || $info['fields'] instanceof \think\Paginator ) && $info['fields']->isEmpty()))): ?><?php echo fields($info['fields'],'title')?'checked':''; endif; ?> value="title" name="fields[]"><span></span> 标题</label> 
				<label class="radio-inline css-input css-checkbox css-checkbox-primary"><input type="checkbox" id="val-terms3" <?php if(!(empty($info['fields']) || (($info['fields'] instanceof \think\Collection || $info['fields'] instanceof \think\Paginator ) && $info['fields']->isEmpty()))): ?><?php echo fields($info['fields'],'image')?'checked':''; endif; ?> value="image" name="fields[]"><span></span> 图片</label> 
				<label class="radio-inline css-input css-checkbox css-checkbox-primary"><input type="checkbox" id="val-terms4" <?php if(!(empty($info['fields']) || (($info['fields'] instanceof \think\Collection || $info['fields'] instanceof \think\Paginator ) && $info['fields']->isEmpty()))): ?><?php echo fields($info['fields'],'info')?'checked':''; endif; ?> value="info" name="fields[]"><span></span> 描述</label> 
				<label class="radio-inline css-input css-checkbox css-checkbox-primary"><input type="checkbox" id="val-terms5" <?php if(!(empty($info['fields']) || (($info['fields'] instanceof \think\Collection || $info['fields'] instanceof \think\Paginator ) && $info['fields']->isEmpty()))): ?><?php echo fields($info['fields'],'url')?'checked':''; endif; ?> value="url" name="fields[]"><span></span> 链接</label> 
				<label class="radio-inline css-input css-checkbox css-checkbox-primary"><input type="checkbox" id="val-terms6" <?php if(!(empty($info['fields']) || (($info['fields'] instanceof \think\Collection || $info['fields'] instanceof \think\Paginator ) && $info['fields']->isEmpty()))): ?><?php echo fields($info['fields'],'entitle')?'checked':''; endif; ?> value="entitle" name="fields[]"><span></span> 副标题</label>
            </div>
              </div>
            </div>
          </div>
		  ...
		  <div class="form-group">
            <div class="col-xs-12">
              <div class="form-material form-material-primary">
              <div>
                <label for="role_id">类型</label></div>
                <div>
                  <label class="css-input css-radio css-radio-primary push-10-r">
                      <input type="radio" value="0" name="type" <?php echo !empty($info['type']) && $info['type']==2?'checked' : ''; ?> <?php echo isset($info['type']) ? ' ': 'checked'; ?>><span></span> 单条
                  </label>
                  <label class="css-input css-radio css-radio-primary">
                      <input type="radio" value="1" name="type" <?php echo !empty($info['type']) && $info['type']==1?'checked' : ''; ?>><span></span> 多条
                  </label>
                </div>
...
<script src="<?php echo Config('public'); ?>assets/js/pages/pages_form_pagesetting.js"></script>
<script>
$(function () {
