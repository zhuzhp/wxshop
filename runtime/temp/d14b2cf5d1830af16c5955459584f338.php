<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\wxshop\public/../application/admin\view\wxapi\index.html";i:1492418204;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
...
<div class="bg-white">
    <section class="content content-boxed overflow-hidden">
        <div class="content-grid">
            <form id="wxForm" action="<?php echo url($tablename.'/index'); ?>" method="get">
                <div class="form-inline">
                    <div class="input-group push-5">
                        <a class="btn btn-sm btn-default" href="<?php echo url($tablename.'/modify'); ?>">添加<?php echo $title; ?></a>
                    </div>
                    <div class="input-group push-5">
                      <input type="text" class="form-control input-sm" placeholder="搜索名称|简介|Token" name="key" value="<?php echo isset($params['key'])?$params['key']:''; ?>">
                    ...
                    <select class="form-control input-sm" name="wx_type" onchange="$('#wxForm').submit();">
                        <?php if(empty($params['wx_type']) || (($params['wx_type'] instanceof \think\Collection || $params['wx_type'] instanceof \think\Paginator ) && $params['wx_type']->isEmpty())): ?><option value="">--请选择账号类型--</option><?php else: ?><option value="<?php echo $params['wx_type']; ?>"><?php echo $wx_type[$params['wx_type']]; ?></option><?php endif; if(is_array($wx_type_list) || $wx_type_list instanceof \think\Collection || $wx_type_list instanceof \think\Paginator): $i = 0; $__LIST__ = $wx_type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wx): $mod = ($i % 2 );++$i;if($wx['id'] != $params['wx_type']): ?>
                        <option value="<?php echo $wx['id']; ?>"><?php echo $wx['status']; ?></option>
                        <?php endif; endforeach; endif; else: echo "" ;endif; if(!(empty($params['wx_type']) || (($params['wx_type'] instanceof \think\Collection || $params['wx_type'] instanceof \think\Paginator ) && $params['wx_type']->isEmpty()))): ?><option value="">--请选择账号类型--</option><?php endif; ?>
                    </select>
                ...
                <div class="row">
                    <table class="js-table-checkable table table-hover">
                        ...
                        <tr class="active">
                            <td><p class="font-w600 push-5"><?php echo $vo['name']; ?></p></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['info']; ?></em></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['token']; ?></em></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['type']; ?></em></td>
                            <td><p class="text-muted remove-margin-b"><?php if($vo['if_disabled'] == '0'): ?>否<?php else: ?>是<?php endif; ?></p></td>
                            <td>
                                <a href="<?php echo url($tablename.'/getoken',['id'=>$vo['id']]); ?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="获取access_token"><i class="fa fa-wechat fa-1x"></i></a>
                                <a href="<?php echo url($tablename.'/modify',['id'=>$vo['id']]); ?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                                <a data-href="<?php echo url($tablename.'/disabled',['id'=>$vo['id']]); ?>" class="btn btn-xs btn-default disabled-one" type="button" data-toggle="tooltip" title="" data-original-title="禁用"><i class="fa fa-times-circle fa-1x"></i></a>
                                <a href="<?php echo url('wxset/index',['id'=>$vo['id']]); ?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="功能设置"><i class="fa fa-cogs fa-1x"></i></a>
                            </td>
                        </tr>
