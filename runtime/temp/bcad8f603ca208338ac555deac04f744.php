<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\www\wxshop\public/../application/admin\view\product\modify.html";i:1491978164;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
    ...
    <section class="content content-boxed">
        ...
        <div class="row items-push push-50-t push-30">
            <div class="col-md-6 col-md-offset-3">
                <form class="js-validation-product form-horizontal push-10-t" action="<?php echo url($tablename.'/'.$modify); ?>" method="post">
                    <input type="hidden" name="id" value="<?php echo isset($info['id'])?$info['id']:''; ?>">
                    <div class="form-group">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <select class="form-control input-sm" id="cateid" name="cateid">
                                    <?php if(empty($info['cateid']) || (($info['cateid'] instanceof \think\Collection || $info['cateid'] instanceof \think\Paginator ) && $info['cateid']->isEmpty())): ?><option value="">--请选择商品分类--</option><?php else: ?><option value="<?php echo $info['cateid']; ?>"><?php echo $info['catename']; ?></option><?php endif; if(is_array($categorylist) || $categorylist instanceof \think\Collection || $categorylist instanceof \think\Paginator): $i = 0; $__LIST__ = $categorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($info['cateid'] != $cate['id']): ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" id="title" name="title" value="<?php echo isset($info['title'])?$info['title']:''; ?>" placeholder="输入商品名称.">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" id="price" name="price" value="<?php echo isset($info['price'])?$info['price']:''; ?>" placeholder="输入价格.">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="form-material">
                                <textarea style="height:460px;" id="content" name="content"><?php echo isset($info['content'])?$info['content']:''; ?></textarea>
...
<script src="<?php echo Config('public'); ?>assets/js/pages/pages_form_product.js"></script>
<script>
    $(function () {
