<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\www\wxshop\public/../application/admin\view\address\index.html";i:1491894221;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
            ...
            <form id="orderForm" action="<?php echo url($tablename.'/index'); ?>" method="get">
                <div class="form-inline">
                    <div class="input-group push-5">
                        <a href="<?php echo url($tablename.'/modify',['member_id'=>$member_id]); ?>" class="btn btn-sm btn-default">添加收货地址</a>
                    </div>
                    <div class="input-group push-5">
                        <input type="text" class="form-control input-sm" placeholder="搜索联系人|电话" value="<?php echo isset($params['key'])?$params['key']:''; ?>">
                      <span class="input-group-btn">
                        <button class="btn btn-sm btn-default" type="button" onclick="var v=$(this).parent().prev().val(); location.href='<?php echo url($tablename.'/index', u_pam($params, null, array('page','key'))); ?>?key='+v+'&id='+<?php echo $member_id; ?>;"> <i class="fa fa-search"></i> </button>
                      </span>
                    </div>
                    <select class="form-control input-sm" onchange="location.href='<?php echo url($tablename.'/index', u_pam($params, null, array('page','pagesize'))); ?>?pagesize='+this.value+'&id='+<?php echo $member_id; ?>">
                ...
                <div class="row">
                    <table class="js-table-checkable table table-hover">
                        ...
                        <tr class="active">
                            ...
                            <td><p class="text-muted remove-margin-b"><?php echo $vo['contant_person']; ?></p></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['tel']; ?></em></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo getAddressById($vo['area_id']); ?></em></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['address']; ?></em></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['if_default']; ?></em></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['update_time']; ?></em></td>
                            <td>
                                <a href="<?php echo url($tablename.'/modify',['id'=>$vo['id'],'member_id'=>$vo['member_id']]); ?>" class="btn btn-xs btn-default modify-one" type="button" data-toggle="tooltip" title="" data-original-title="修改"><i class="fa fa-pencil"></i></a>
                                <a data-href="<?php echo url($tablename.'/delete',['id'=>$vo['id'],'member_id'=>$vo['member_id']]); ?>" class="btn btn-xs btn-default delete-one" type="button" data-toggle="tooltip" title="" data-original-title="删除"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
