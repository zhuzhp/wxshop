<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\www\wxshop\public/../application/admin\view\role\index.html";i:1491978808;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
  ...
  <section class="content content-boxed overflow-hidden">
    <div class="content-grid">
      <div class="form-inline">
        ...
        <div class="input-group push-5">
          <input type="text" class="form-control input-sm" placeholder="搜索角色名" value="<?php echo isset($params['key'])?$params['key']:''; ?>">
          <span class="input-group-btn">
            <button class="btn btn-sm btn-default" type="button" onclick="var v=$(this).parent().prev().val(); location.href='<?php echo url($tablename.'/index', u_pam($params, null, array('page','key'))); ?>?key='+v;"> <i class="fa fa-search"></i> </button>
          </span>
        </div>
        <select class="form-control input-sm" onchange="location.href='<?php echo url($tablename.'/index', u_pam($params, null, array('page','pagesize'))); ?>?pagesize='+this.value">
      ...
      <div class="row">
        <table class="js-table-checkable table table-hover">
          ...
          <tr>
            ...
            <td><p class="font-w600 push-5"><?php echo $vo['name']; ?></p>
              <p class="text-muted remove-margin-b"><?php echo $vo['remark']; ?></p></td>
              <td>
			  <?php if(empty($vo['auth_access']) || (($vo['auth_access'] instanceof \think\Collection || $vo['auth_access'] instanceof \think\Paginator ) && $vo['auth_access']->isEmpty())): ?><a href="<?php echo url($tablename.'/modifyrole',['id'=>$vo['id']]); ?>" class="label label-danger">添加权限</a><?php else: ?><a href="<?php echo url($tablename.'/modifyrole',['id'=>$vo['id']]); ?>" class="label label-default">修改权限</a><?php endif; ?>
            </td>
              <td class="hidden-xs"><em class="text-muted"><?php echo $vo['update_time']; ?></em> </td>
			<td>	
			<button onclick="edit(<?php echo $vo['id']; ?>,'<?php echo $vo['name']; ?>','<?php echo $vo['remark']; ?>');" data-toggle="modal" data-target="#modal-top" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="修改" data-original-title="修改"><i class="fa fa-pencil"></i></button>
      ...
      <div class="block block-themed block-transparent remove-margin-b">
        ...
        <div class="block-content">
          <div class="block-content block-content-narrow">
            <form class="js-validation-role form-horizontal push-10-t" action="<?php echo url($tablename.'/modify'); ?>" method="post" novalidate="novalidate">
