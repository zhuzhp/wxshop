<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\www\wxshop\public/../application/admin\view\pagesetting\modifylist.html";i:1491484135;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
...
<!-- END Hero Content -->
<div class="bg-white">
<form action="<?php echo url($tablename.'/modifylistupdatesort',['id'=>$settinginfo['id']]); ?>" method="post">
  <section class="content content-boxed overflow-hidden">
    <div class="content-grid">
      <div class="form-inline">
        <div class="input-group push-5"><a class="btn btn-sm btn-default" href="<?php echo url($tablename.'/modifylistvalue',['id'=>$settinginfo['id']]); ?>">添加<?php echo $title; ?></a><span style="display:inline-block; width:20px; text-align:center; color:#ddd;">|</span><button class="btn btn-sm btn-default" type="submit">修改排序</button></div>
      </div>
      <div class="row">
        ...
        <tr>
          ...
          <td class="text-center"><div class="btn-group">
              <a href="<?php echo url($tablename.'/modifylistvalue',['editid'=>$vo['id'],'id'=>$settinginfo['id']]); ?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="修改"><i class="fa fa-pencil"></i></a>
              <a data-href="<?php echo url($tablename.'/modifylistdelete',['id'=>$vo['id'],'pid'=>$settinginfo['id']]); ?>" class="btn btn-xs btn-default delete-one" type="button" data-toggle="tooltip" title="" data-original-title="删除"><i class="fa fa-times"></i></a>
            </div></td>
        </tr>
