<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\www\wxshop\public/../application/admin\view\address\modify.html";i:1491980154;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
    ...
    <section class="content content-boxed">
        ...
        <div class="row items-push push-50-t push-30">
            <div class="col-md-6 col-md-offset-3">
                <form class="js-validation-address form-horizontal push-10-t" action="<?php echo url($tablename.'/modify'); ?>" method="post">
                    <input type="hidden" name="member_id" value="<?php echo $params['member_id']; ?>" />
                    <input type="hidden" name="id" value="<?php echo isset($info['id'])?$info['id']:''; ?>" />

                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material form-material-primary">
                                <input class="form-control" type="text" id="contant_person" name="contant_person" placeholder="联系人.." value="<?php echo isset($info['contant_person'])?$info['contant_person']:''; ?>">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material form-material-primary">
                                <input class="form-control" type="text" id="tel" name="tel" placeholder="电话.."  value="<?php echo isset($info['tel'])?$info['tel']:''; ?>">
                    ...
                    <div class="form-group" style="margin-top:5px;">
                        <div class="col-xs-12">
                            <div class="form-material form-material-primary">
                                ...
                                <input type="hidden" name="area_id" id="area_id" value="<?php echo isset($info['area_id'])?$info['area_id']:''; ?>" />
                                <?php if($action == 'add'): ?>
                                <select class="form-control select-box" id="area_adss" size="1" onchange="checkArea(this)" style="width:30%;display: inline;float:left;margin-right: 10px;">
                                    ...
                                    <?php if(is_array($areaList) || $areaList instanceof \think\Collection || $areaList instanceof \think\Paginator): $i = 0; $__LIST__ = $areaList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$area): $mod = ($i % 2 );++$i;?>
                                    <option value="<?php echo $area['id']; ?>"><?php echo $area['catename']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <?php else: if(is_array($areaList) || $areaList instanceof \think\Collection || $areaList instanceof \think\Paginator): $i = 0; $__LIST__ = $areaList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                    <select class="form-control select-box" id="area_adss" size="1" onchange="checkArea(this)" style="width:30%;display: inline;float:left;margin-right: 10px;">
                                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$area): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $area['id']; ?>"><?php echo $area['catename']; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material form-material-primary">
                                <input class="form-control" type="text" id="address" name="address" placeholder="详细地址(不包含省市区).." value="<?php echo isset($info['address'])?$info['address']:''; ?>">
                            ...
                            <div class="form-material form-material-primary">
                                ...
                                <div>
                                    <label class="css-input css-radio css-radio-primary push-10-r">
                                        <input type="radio" value="1" name="if_default" <?php echo !empty($info['if_default']) && $info['if_default']==1?'checked' : ''; ?> <?php echo isset($info['if_default']) ? '' : 'checked'; ?>><span></span> 是
                                    </label>
                                    <label class="css-input css-radio css-radio-primary">
                                        <input type="radio" value="0" name="if_default" <?php echo !empty($info['if_default']) && $info['if_default']==2?'checked' : ''; ?>><span></span> 否
                                    </label>
                                </div>
...
<script src="<?php echo Config('public'); ?>assets/js/pages/pages_form_address.js"></script>
<script>
    $(function () {
