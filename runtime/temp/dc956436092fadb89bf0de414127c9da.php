<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\www\wxshop\public/../application/admin\view\common\modify.html";i:1482907612;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
...
<meta charset="utf-8">
<title>
<?php echo $title; $groupnav = 'Master'; $activenav = 'User/index'; ?>
  ...
  <section class="content content-boxed">
    ...
    <div class="row items-push push-50-t push-30">
      <div class="col-md-6 col-md-offset-3">
        <form class="js-validation-user-updatepwd form-horizontal push-10-t" action="<?php echo url($tablename.'/updatepwd'); ?>" method="post">
          <div class="form-group">
            <div class="col-xs-12">
              <div class="form-material form-material-primary">
                <input type="hidden" name="id" value="<?php echo isset($info['id'])?$info['id']:''; ?>">
                <span><?php echo isset($info['username'])?$info['username']:''; ?></span>
          ...
          <div class="form-group">
            <div class="col-xs-12">
              <div class="form-material form-material-primary">
                <input class="form-control" type="password" id="ypassword" name="ypassword" placeholder="原来的登录密码..">
                <label for="password">原登录密码</label>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="col-xs-12">
              <div class="form-material form-material-primary">
                <input class="form-control" type="password" id="password" name="password" placeholder="新登录密码..">
		  ...
		  <div class="form-group">
            <div class="col-xs-12">
              <div class="form-material form-material-primary">
                <input class="form-control" type="password" id="repassword" name="repassword" placeholder="确认登录密码..">
                <label for="password">确认登录密码</label>
              </div>
            </div>
          </div>
          <div class="form-group">
...
<script src="<?php echo Config('public'); ?>assets/js/pages/pages_form_updatepwd.js"></script>
<script>
$(function () {
