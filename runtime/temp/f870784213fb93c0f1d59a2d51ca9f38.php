<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\www\wxshop\public/../application/admin\view\wxapi\gettoken.html";i:1492053175;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
    ...
    <section class="content content-boxed">
        ...
        <div class="row items-push push-50-t push-30">
            <div class="col-md-6 col-md-offset-3">
                <form class="js-validation-token form-horizontal push-10-t" action="<?php echo url($tablename.'/getToken'); ?>" method="post">
                    <input type="hidden" name="id" value="<?php echo isset($info['id'])?$info['id']:''; ?>">
                    <div class="form-group">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" id="name" name="name" readonly value="<?php echo isset($info['name'])?$info['name']:''; ?>" placeholder="输入名称..">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="form-material">
                                <input class="form-control" type="text" id="token" name="token" readonly value="<?php echo isset($info['token'])?$info['token']:''; ?>" placeholder="输入Token..">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="form-material">
                                <input class="form-control" type="text" id="encodingAESKey" name="encodingAESKey" readonly value="<?php echo isset($info['encodingAESKey'])?$info['encodingAESKey']:''; ?>" placeholder="输入EncodingAESKey..">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="form-material">
                                <input class="form-control" type="text" id="appId" name="appId" readonly value="<?php echo isset($info['appId'])?$info['appId']:''; ?>" placeholder="输入AppID..">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="form-material">
                                <input class="form-control" type="text" id="appSecret" name="appSecret" readonly value="<?php echo isset($info['appSecret'])?$info['appSecret']:''; ?>" placeholder="输入AppSecret..">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="form-material">
                                <input class="form-control" type="text" id="access_token" name="access_token" readonly value="<?php echo isset($info['access_token'])?$info['access_token']:''; ?>" placeholder="点击获取Access_Token..">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="form-material">
                                <input class="form-control" type="text" id="expires_in" name="expires_in" readonly value="<?php echo isset($info['expires_in'])?$info['expires_in']:''; ?>" placeholder="点击获取Expires_Time..">
                                <label for="expires_in">Expires_Time</label>
                            </div>
                        </div>
                    </div>
...
<script src="<?php echo Config('public'); ?>assets/js/pages/pages_form_token.js"></script>
<script>
    $(function () {
