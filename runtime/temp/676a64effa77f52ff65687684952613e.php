<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\www\wxshop\public/../application/admin\view\order\goodslist.html";i:1491787513;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
...
<div class="bg-white">
    <section class="content content-boxed overflow-hidden">
        <div class="content-grid">
            <form id="orderForm" action="<?php echo url($tablename.'/goodslist',['id'=>$orderid]); ?>" method="get">
                <div class="form-inline">
                    <div class="input-group push-5">
                        <a class="btn btn-sm btn-default"><?php echo $title; ?>编号：</a>
                        <a style="display:inline-block; width:130px; text-align:center; color:#444242;cursor: pointer;text-decoration: underline" href="<?php echo url($tablename.'/index'); ?>"><b>201704092140119</b></a>
                ...
                <div class="row">
                    <table class="js-table-checkable table table-hover">
                        ...
                        <tr class="active">
                            <td><p class="font-w600 push-5"><?php echo $vo['productid']; ?></p></td>
                            <td><p class="text-muted remove-margin-b"><?php echo $vo['product_name']; ?></p></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['price']; ?></em></td>
                            <td class="hidden-xs"><em class="text-muted"><?php echo $vo['num']; ?></em></td>
