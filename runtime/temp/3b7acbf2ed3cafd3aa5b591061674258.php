<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\www\wxshop\public/../application/admin\view\pagesetting\index.html";i:1491978278;s:63:"D:\www\wxshop\public/../application/admin\view\public\base.html";i:1491877418;s:62:"D:\www\wxshop\public/../application/admin\view\public\nav.html";i:1491788115;}*/ ?>
<!DOCTYPE html>
  ...
  <section class="content content-boxed overflow-hidden">
    <div class="content-grid">
      <div class="form-inline">
        <div class="input-group push-5"> <a class="btn btn-sm btn-default" data-toggle="modal" href="<?php echo url($tablename.'/add'); ?>">添加<?php echo $title; ?></a></div>
        <div class="input-group push-5">
          <input type="text" class="form-control input-sm" placeholder="搜索标题" value="<?php echo isset($params['key'])?$params['key']:''; ?>">
      ...
      <div class="row">
		...
		<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <tr>		  
            ...
            <td><p class="font-w600 push-10"><?php echo $vo['title']; ?></p></td>
			 <td><?php echo $vo['key']; ?></td>
            <td><em class="text-muted"><?php echo $vo['update_time']; ?></em> </td>
			<td class="text-center"><div class="btn-group">
				<a href="<?php if($vo['type'] == '1'): ?><?php echo url($tablename.'/modifylist',['id'=>$vo['id']]); else: ?><?php echo url($tablename.'/modifyvalue',['id'=>$vo['id']]); endif; ?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="内容"><i class="glyphicon glyphicon-zoom-in fa-1x"></i></a>
